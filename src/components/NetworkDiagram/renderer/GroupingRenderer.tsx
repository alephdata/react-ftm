...
> {
  ...
  render() {
    ...
    const isHighlighted =
      isSelected || layout.isGroupingMemberSelected(grouping) || layout.selection.length === 0;
    ...
    const displayColor =
      grouping && (isHighlighted || hovered) ? grouping.color : layout.config.UNSELECTED_COLOR;
