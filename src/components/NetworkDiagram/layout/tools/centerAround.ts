import { GraphLayout, Rectangle, Vertex } from '../../layout';
...
const centerAround = (layout: GraphLayout, vertsToCenter?: Array<Vertex>, vertsToPosition?: Array<Vertex>): any => {
  ...
  const positioningFunc = alignCircle({ vertices: toPosition, edges: adjacentEdges, groupings, options: { center: centerBBox.getCenter(), radius } });
