...
import { BarChart, Bar, Cell, XAxis, Tooltip, ReferenceArea, ResponsiveContainer } from 'recharts';
    ...
    if (active && payload && payload.length) {
      ...
      return (
        <div className="Histogram__tooltip">
          ...
          {data.isUncertain && (
            <p className="Histogram__tooltip__secondary">{data.uncertainWarning}</p>
          )}
        </div>
      );
    }
