...
export default class HistogramWrapper extends React.Component {
  render() {
    const sampleData = [
      {
        ...
        count: 29,
        isUncertain: true,
        uncertainWarning: '*This count includes dates where no day or month is specified',
    ...
    return <Histogram data={sampleData} dataPropName="count" containerProps={{ height: 200 }} />;
  }
}
